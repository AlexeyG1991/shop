...
function documentActions(e) {
    ...
    if (targetElement.closest('[data-parent]')) {
        ...
        if (subMenu) {
            ...
            console.log('Нема такого підменю :(')
        }
        e.preventDefault();
    }
...
// проверяем на каком устроймтве открыт сайт
const isMobile = {
    Android: function () {
...
// после проверки добавляем клас в зависимости от устройства
if (isMobile.any()) {
    document.body.classList.add('_touch');

    let menuArrows = document.querySelectorAll('.phones-header__arrow');
...
if (spollersArray.length > 0) {
    ...
    // Робота з контентом
    function initSpollerBody(spollersBlock, hideSpollierBody = true) {
        ...
        if (el.hasAttribute('data-spoller') || el.closest('[data-spoller]')) {
            ...
            if (!spollersBlock.querySelectorAll('._slide').length) {
                if (oneSpoller && !spollerTitle.classList.contains('_active')) {
                    hideSpolliersBody(spollersBlock);
                }
    ...
    function hideSpolliersBody(spollersBlock) {
...
// ---------------------------- tips ---------------------------
let tips = document.querySelectorAll('.media-main-block__tip')
tips.forEach(item => {
    item.addEventListener('click', (e) => {
        item.classList.toggle('active-tips')
    })
})
...
let selectLanguage = function () {
    ...
    function selectChoose() {
        let text = this.innerText,
            selectLanguage = this.closest('.select'),
            currentText = selectLanguage.querySelector('.select__current');
        currentText.innerText = text;
        selectLanguage.classList.remove('is-active');
    }
};
